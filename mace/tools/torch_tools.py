...
def occupancies_to_node_attrs(
    occupancies: list,  # [{element_symbol: fraction}, ...] per site
    z_table: "AtomicNumberTable",  # type: ignore[name-defined]
) -> torch.Tensor:
    """Convert per-site occupancy dicts to fractional node attribute vectors.
